...
class WebdriverXPathSelector(Selector):
    ...
    def send_keys(self, keys):
        """Send keys from selenium element."""
        self.element.send_keys(keys) if self.element else None

    def click(self):
        """Click element from selenium element."""
        self.element.click() if self.element else None
